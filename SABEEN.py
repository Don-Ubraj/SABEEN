...
def contact():
	...
	os.system('xdg-open https://www.facebook.com/profile.php?id=100091910462021')
...
|  $$$$$$/| $$  | $$| $$$$$$$/| $$$$$$$$| $$$$$$$$| $$ \  $$
 ...
 \______/ |__/  |__/|_______/ |________/|________/|__/  \__/                                                                                                                      

 AUTHOR     : SABEEN

 GITHUB     : SECRET 

 FACEBOOK   : SABEEN HERE
...
def login():
	...
	try:
		...
		try:
			...
			animation(f'\033[0m \u001b[36m>>\033[1;37m MUJI NET ON GAR')
...
def login_lagi334():
 ...
 [\u001b[36m4\033[1;37m] THEN OPEN EXTENSION COPY COOKIE""")
		...
		your_cookies = input(' [\u001b[36m•\033[1;37m] COOKIE HAL RADABAN : ')
				...
				if 'How do you want to log into Facebook?' in str(response2) or '/login/?next=' in str(response2):
					...
					if 'https://m.facebook.com/dialog/oauth/?auth_type=rerequest&redirect_uri=' in str(response3.url):
						...
						if 'Success!' in str(response6):
							...
							animation(f'\033[0m \u001b[36m>>\033[1;37m LOGIN VO RERUN HAN');exit()

			except Exception as e:

				linex()

				animation(f'\033[0m \u001b[36m>>\033[1;37m RADABAN EXPIRED COOKIES HALXAS')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r {P}[SABEEN]{P} {P}{loop}{P}/{P}{len(id)}{P} OK{P}[{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
